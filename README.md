# AI Content Pipeline — 10 скиллов для Claude Code

Система из 10 AI-агентов, которая автоматизирует создание контента — от исследования темы до публикации в WordPress и отслеживания позиций. Каждый агент — отдельный скилл для [Claude Code](https://claude.ai/code).
